...
**Extension name:** `seg`
**Version:** 0.7
**Status:** Superseded by version 0.8, `../segmentation-ext-spec.md`, which changes `label_value` to a list of values, moves groups out of the file, and makes `color` a string. Kept because a 0.8 reader migrates files of this version (§6.3 of the current specification), and this is the record of what they meant.
